...
public class button1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView = new com.facebook.ads.AdView(this, "520210448517491_520214265183776",

                com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer = (LinearLayout) findViewById(R.id.banner_container_main);
        adContainer.addView(adView);
        adView.loadAd();


        adView2 = new com.facebook.ads.AdView(this, "520210448517491_520214481850421",

                AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer2 = (LinearLayout) findViewById(R.id.banner_container_main_1);
