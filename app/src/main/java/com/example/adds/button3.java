...
public class button3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView5 = new com.facebook.ads.AdView(this, "520210448517491_520217665183436",

                AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer = (LinearLayout) findViewById(R.id.banner_container5);
        adContainer.addView(adView5);
        adView5.loadAd();


        adView6 = new com.facebook.ads.AdView(this, "520210448517491_520217958516740",

                AdSize.BANNER_HEIGHT_50);
        LinearLayout adContainer2 = (LinearLayout) findViewById(R.id.banner_container6);
...
//        adView6 = findViewById(R.id.ad_view6);
//
